...
function App() {
  ...
  const validacion = () =>{
    if(inputNombre.current.value === "" || inputWhatsapp.current.value === "" || inputCorreo.current.value === "" || inputCorreo.current.value === "" || numerOfStoriesSelectInput.current.options === 0 ){
      console.log("vacio")
    }else{
      console.log("texto")
    }
